...
namespace EPiServer.Templates.Alloy.Models.Blocks
{
    ...
    public class SiteLogotypeBlock : SiteBlockData
    {
        ...
        [UIHint(UIHint.Image)]
        public virtual Url SiteLogotypeUrl
        {
            get
            {
                var url = this.GetPropertyValue(b => b.SiteLogotypeUrl);
            ...
            set
            {
                this.SetPropertyValue(b => b.SiteLogotypeUrl, value);
            }
        }

        [CultureSpecific]
        public virtual string SiteLogotypeTitle { get; set; }
    }
}