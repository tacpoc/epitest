...
namespace EPiServer.Templates.Alloy.Models.Blocks
{
    ...
    public class ContactBlock : SiteBlockData
    {
        ...
        [CultureSpecific]
        [UIHint(UIHint.Image)]
        public virtual Url ContactBlockImage { get; set; }

        [Display(
            GroupName = SystemTabNames.Content,
            Order = 2)]
        [CultureSpecific]
        public virtual string ContactBlockHeading { get; set; }
        ...
        [Display(
            ...
            Order = 4)]
        [CultureSpecific]
        public virtual string ContactBlockLinkText { get; set; }

        [Display(
            GroupName = SystemTabNames.Content,
            Order = 5)]
        [CultureSpecific]
        public virtual Url ContactBlockLinkUrl { get; set; }
    }
}