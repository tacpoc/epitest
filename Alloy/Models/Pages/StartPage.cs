...
namespace EPiServer.Templates.Alloy.Models.Pages
{
    ...
    [AvailablePageTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(SearchPage), typeof(LandingPage) }, // Pages we can create under the start page...
    ...
    public class StartPage : SitePageData
    {
        ...
        public virtual PageReference CompanyInformationPageLink { get; set; }
