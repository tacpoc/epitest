...
namespace EPiServer.Templates.Alloy.Business.ContentProviders
{
    ...
    public class ClonedContentProvider : ContentProvider, IPageCriteriaQueryService
    {
        ...
        private IList<ContentReference> FilterByCategory(IEnumerable<ContentReference> contentReferences)
        {
            ...
            var filteredChildren = new List<ContentReference>();

            foreach (var contentReference in contentReferences)
            {
                var content = ContentLoader.Get<IContent>(contentReference) as ICategorizable;
        ...
        /// </summary>
        public override PageProviderCapabilities Capabilities { get { return PageProviderCapabilities.Search; } }
